...
class FewShotExamples:
    ...
    SEARCH_ADDRESS = [
        ...
        {"request": "проверь адрес Большевиков 68 корпус 1", "params": {"query": "Большевиков 68 к1"}},
        {"request": "где находится Лиговский проспект 50", "params": {"query": "Лиговский проспект 50"}},
    ]
    ...
    GET_DISTRICT_INFO_BY_ADDRESS = [
        {"request": "в каком районе находится Невский 1?", "params": {"address": "Невский проспект 1"}},
    ...
    FIND_NEAREST_MFC = [
        ...
        {"request": "ближайший МФЦ от метро Пионерская", "params": {"location": "метро Пионерская"}},
        {"request": "где оформить документы около Большевиков 68", "params": {"location": "Большевиков 68"}},
        {"request": "МФЦ у станции Василеостровская", "params": {"location": "метро Василеостровская"}},
    ]
    ...
    # === Healthcare ===
    GET_POLYCLINICS = [
        {"request": "моя поликлиника по адресу Невский 1", "params": {"address": "Невский проспект 1"}},
        {"request": "к какой поликлинике прикреплён дом на Садовой 50?", "params": {"address": "Садовая 50"}},
    ]
    ...
    GET_SCHOOLS_BY_ADDRESS = [
        ...
        {"request": "к какой школе прикреплён дом на Большевиков 68?", "params": {"address": "Большевиков 68"}},
    ]
    ...
    GET_KINDERGARTENS = [
        {"request": "детские сады в Невском районе для ребёнка 3 лет", "params": {"district": "Невский", "age_years": 3, "age_months": 0}},
        {"request": "садики в Центральном для малыша 2,5 года", "params": {"district": "Центральный", "age_years": 2, "age_months": 6}},
    ]

    # === Housing ===
    GET_MANAGEMENT_COMPANY = [
        {"request": "управляющая компания для Невский 1", "params": {"address": "Невский проспект 1"}},
    ...
    GET_DISCONNECTIONS = [
        ...
        {"request": "когда включат горячую воду на Садовой 50?", "params": {"address": "Садовая 50"}},
    ]
    ...
    GET_SPORTGROUNDS = [
        ...
        {"request": "где позаниматься спортом в Центральном?", "params": {"district": "Центральный"}},
    ]
    ...
    GET_BEAUTIFUL_PLACES = [
        {"request": "достопримечательности в Центральном районе", "params": {"district": "Центральный"}},
...
class AddressSearchResult(BaseModel):
    ...
    coordinates: tuple[float, float] | None = Field(default=None, description="Координаты (lat, lon)")
