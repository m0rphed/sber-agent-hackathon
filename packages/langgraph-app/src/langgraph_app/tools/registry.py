...
def _get_tools_by_category(provider: ProviderType = "default") -> dict[ToolCategory, list[BaseTool]]:
    """
...
def get_category_names() -> dict[ToolCategory, list[str]]:
    ...
    return {
        ...
        ToolCategory.DISTRICT: ["get_districts_list", "get_district_info", "get_district_info_by_address"],
        
        # Городские сервисы
        ToolCategory.MFC: ["find_nearest_mfc", "get_mfc_by_district", "get_all_mfc"],
        ToolCategory.POLYCLINIC: ["get_polyclinics_by_address"],
        ToolCategory.SCHOOL: ["get_schools_by_address", "get_schools_in_district", "get_school_by_id"],
        ...
        ToolCategory.PETS: ["search_address", "get_pet_parks", "get_vet_clinics", "get_pet_shelters"],
