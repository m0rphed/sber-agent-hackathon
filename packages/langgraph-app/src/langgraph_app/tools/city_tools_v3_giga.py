...
@giga_tool(
    few_shot_examples=[
        ...
        {"request": "Найди МФЦ около моего дома на Большевиков 68", "params": {"address": "Большевиков 68"}},
    ]
)
@handle_api_errors
...
@giga_tool(
    few_shot_examples=[
        {"request": "К какой поликлинике я прикреплён по адресу Невский 10?", "params": {"address": "Невский 10"}},
        {"request": "Поликлиника для адреса Садовая 50", "params": {"address": "Садовая 50"}},
        {"request": "Моя поликлиника, живу на Большевиков 68", "params": {"address": "Большевиков 68"}},
    ]
)
@handle_api_errors
...
@giga_tool(
    few_shot_examples=[
        {"request": "К какой школе прикреплён адрес Невский 10?", "params": {"address": "Невский 10"}},
        {"request": "Школа по прописке Садовая 50", "params": {"address": "Садовая 50"}},
        {"request": "В какую школу идти ребёнку, живём на Большевиков 68", "params": {"address": "Большевиков 68"}},
    ]
)
@handle_api_errors
...
@giga_tool(
    few_shot_examples=[
        ...
        {"request": "Какие школы есть в Центральном районе?", "params": {"district": "Центральный"}},
...
@giga_tool(
    few_shot_examples=[
        ...
        {"request": "Управляющая компания по адресу Садовая 50", "params": {"address": "Садовая 50"}},
        {"request": "Кто управляет домом на Большевиков 68?", "params": {"address": "Большевиков 68"}},
    ]
)
@handle_api_errors
...
@giga_tool(
    few_shot_examples=[
        ...
        {"request": "Какие есть детсады в Центральном районе?", "params": {"district": "Центральный"}},
        {"request": "Садики в Приморском районе", "params": {"district": "Приморский"}},
    ]
)
@handle_api_errors
    ...
    async with ApiClientUnified(verbose=False) as client:
        ...
        for k in kinders[:10]:
            if isinstance(k, dict):
                name = k.get("name") or k.get("title") or k.get("short_name") or "Детский сад"
...
@giga_tool(
    few_shot_examples=[
        {"request": "Где площадки для выгула собак рядом с координатами 59.93, 30.33?", "params": {"lat": 59.93, "lon": 30.33, "radius_km": 5.0}},
        {"request": "Площадки для собак около Невского", "params": {"lat": 59.9343, "lon": 30.3351, "radius_km": 5.0}},
    ]
)
@handle_api_errors
...
@giga_tool(
    few_shot_examples=[
        {"request": "Ветеринарные клиники рядом с координатами 59.93, 30.33", "params": {"lat": 59.93, "lon": 30.33, "radius_km": 10.0}},
        {"request": "Где ветклиника рядом?", "params": {"lat": 59.9343, "lon": 30.3351, "radius_km": 10.0}},
    ]
)
@handle_api_errors
...
@giga_tool(
    few_shot_examples=[
        {"request": "Приюты для животных рядом", "params": {"lat": 59.93, "lon": 30.33, "radius_km": 10.0}},
        {"request": "Где приют для собак?", "params": {"lat": 59.9343, "lon": 30.3351, "radius_km": 10.0}},
    ]
)
@handle_api_errors
...
@giga_tool(
    few_shot_examples=[
        {"request": "Какие мероприятия проходят рядом?", "params": {"lat": 59.93, "lon": 30.33, "radius_km": 10.0, "count": 5}},
        {"request": "Что интересного в городе сегодня?", "params": {"lat": 59.9343, "lon": 30.3351, "radius_km": 10.0, "count": 5}},
    ]
)
@handle_api_errors
...
@giga_tool(
    few_shot_examples=[
        {"request": "Спортивные соревнования в Невском районе", "params": {"district": "Невский", "count": 5}},
        {"request": "Какие спортивные события в СПб?", "params": {"district": "Центральный", "count": 5}},
    ]
)
@handle_api_errors
...
@giga_tool(
    few_shot_examples=[
        {"request": "Услуги для пенсионеров в Невском районе", "params": {"district": "Невский", "count": 5}},
...
@giga_tool(
    few_shot_examples=[
        {"request": "Горячие линии для пенсионеров в Невском районе", "params": {"district": "Невский"}},
...
@giga_tool(
    few_shot_examples=[
        {"request": "Спортплощадки в Невском районе", "params": {"district": "Невский", "count": 5}},
...
@giga_tool(
    few_shot_examples=[
        {"request": "Достопримечательности в Невском районе", "params": {"district": "Невский", "count": 5}},
...
@giga_tool(
    few_shot_examples=[
        {"request": "Пункты сбора мусора рядом", "params": {"lat": 59.93, "lon": 30.33, "count": 5}},
        {"request": "Где сдать раздельный мусор?", "params": {"lat": 59.9343, "lon": 30.3351, "count": 5}},
    ]
)
@handle_api_errors
...
@giga_tool(
    few_shot_examples=[
        {"request": "Дорожные работы в Невском районе", "params": {"district": "Невский", "count": 10}},
